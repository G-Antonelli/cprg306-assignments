...
export default function NewItem() {
    ...
    return (
        <div className="bg-black min-h-screen flex justify-center items-start">
            <div className="flex">
                <form onSubmit={handleSubmit} className="bg-black p-5 max-w-sm w-full">
                    <div className="text-black">
                        <input
                            className="p-2 mt-1 w-full border-r-2 rounded-lg border-gray-400 bg-gray-50 focus:bg-gray-200"
                            type="text"
